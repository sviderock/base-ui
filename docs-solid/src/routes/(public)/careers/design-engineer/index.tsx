  ...
  return (
    <div class="HomepageRoot">
      ...
      <div class="ContentLayoutMain">
        <h1 class="mb-4 text-3xl font-bold text-balance">Design Engineer</h1>
        <p class="-mt-2 mb-5 text-lg text-pretty text-gray">
          Help us make Base UI the most intuitive, accessible, and powerful open-source UI library
          for React.
        </p>
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">About Base UI</h2>
        <p class="mb-4">
        ...
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">The role</h2>
        <p class="mb-4">
        ...
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Responsibilities</h2>
        <ul class="mb-4 ml-4.5 list-disc">
          <li class="mb-0.5">Report to our OSS Engineering Manager.</li>
          <li class="mb-0.5">
          ...
          <li class="mb-0.5">Build and maintain the Base UI website.</li>
          <li class="mb-0.5">
          ...
          <li class="mb-0.5">Help out with developer support on both Github and Discord.</li>
        </ul>
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Requirements</h2>
        <ul class="mb-4 ml-4.5 list-disc">
          <li class="mb-0.5">We are targeting 7+ years of web development experience.</li>
          <li class="mb-0.5">
          ...
          <li class="mb-0.5">Advanced understanding of design principles.</li>
          <li class="mb-0.5">A passion for craft, a keen eye for detail, and exquisite taste.</li>
          <li class="mb-0.5">Excellent written and verbal communication skills.</li>
          <li class="mb-0.5">Experience working remotely and communicating asynchronously.</li>
        </ul>
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Benefits</h2>
        <ul class="mb-4 ml-4.5 list-disc">
          <li class="mb-0.5">$200k–$290k USD base salary.</li>
          <li class="mb-0.5">
            Subsidized healthcare package (dependent on employment path and location).
          </li>
          <li class="mb-0.5">Flexible time-off. We provide 33 days of paid time-off globally.</li>
          <li class="mb-0.5">100% remote. Our entire company is globally distributed.</li>
          <li class="mb-0.5">
            Company retreats. We meet up every 8 months for a week of work and fun.
          </li>
          <li class="mb-0.5">Office equipment. We let you choose the hardware of your choice.</li>
          <li class="mb-0.5">
        ...
        <h2 class="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Application</h2>
        <p class="mb-4">The hiring process will consist of 6 stages:</p>
        <ol class="mb-4 ml-4.5 list-inside list-decimal">
          <li class="mb-0.5">Resume review.</li>
          <li class="mb-0.5">45 minute Phone screen.</li>
          <li class="mb-0.5">React challenge (asynchronous).</li>
          <li class="mb-0.5">60 minute meeting with Product lead.</li>
          <li class="mb-0.5">90 minute meeting with the Base UI team.</li>
          <li class="mb-0.5">60 minute culture-fit interview.</li>
        </ol>
        <a
          class="Link -m-1 mr-[0.125em] inline-flex items-center gap-1 gap-[0.25em] p-1"
