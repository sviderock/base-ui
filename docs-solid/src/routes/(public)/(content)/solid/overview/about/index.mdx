...
<Subtitle>An open-source Solid component library for building accessible user interfaces.</Subtitle>
<Meta
  name="description"
  content="An overview of Base UI, providing information on its history, team, and goals."
/>

From the creators of Radix, Material UI, and Floating UI, Base UI is an unstyled Solid component library for building accessible user interfaces.
